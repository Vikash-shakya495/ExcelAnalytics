...
export default function FeatureSection() {
  return (
      ...
      >
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">
            Premium Features
          </h2>
          <p className="mt-3 sm:mt-4 text-gray-300 max-w-xl mx-auto text-sm sm:text-base">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto">
        {features.map(({ icon, title, desc, color }, i) => (
          ...
          >
            {/* Icon Glow */}
            <div
              className={`w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 flex items-center justify-center rounded-full ring-4 ${color} bg-white/10 backdrop-blur-md shadow-inner animate-pulse group-hover:animate-bounce`}
            >
