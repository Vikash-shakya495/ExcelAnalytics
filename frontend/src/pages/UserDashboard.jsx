...
export default function UserDashboard() {
  ...
  const renderContent = () => {
    switch (activeSection) {
              ...
              <>
                ...
                <div className="flex gap-4 mt-4">
                  <button
                    ...
                    className="px-4 py-2 bg-purple-700 rounded-md text-white hover:bg-purple-600 transition"
                  >
                    Download Insights
                  </button>
                  <button
      ...
      case SECTIONS.CHART_ANALYSIS:
        return (
          <div className="mt-10 max-w-6xl mx-auto bg-gradient-to-br from-[#100024] to-[#1c002e] rounded-2xl border border-purple-800/50 shadow-2xl backdrop-blur-xl p-4 md:p-8 text-white transition-all duration-300">
            ...
            {selectedUpload && selectedUpload.data && selectedUpload.data.length > 0 ? (
              <div className="bg-black/10 border border-purple-800/40 rounded-xl p-0 shadow-inner mt-6">
                <ChartVisualization
  ...
  return (
    <div className="min-h-screen mt-16 bg-gradient-to-br from-purple-950 via-black to-purple-950 text-white font-sans flex flex-col md:flex-row">
      {/* Sidebar */}
      <nav className="w-full md:w-64 bg-gradient-to-tr from-[#0e0023] to-[#26004a] p-4 sm:p-6 border-b md:border-b-0 md:border-r border-purple-900 shadow-2xl backdrop-blur-md flex flex-col items-center md:items-start justify-between md:justify-start">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold mb-3 sm:mb-4 md:mb-10 bg-gradient-to-r from-purple-400 via-pink-600 to-indigo-500 bg-clip-text text-transparent select-none text-center md:text-left">
          📊 Dashboard
        </h1>
        ...
        <div className="md:mt-auto text-xs text-purple-500 text-center pt-6 border-t border-purple-800 opacity-60 w-full">
